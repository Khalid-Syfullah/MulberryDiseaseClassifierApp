package com.example.mulberrydiseaseclassifier.ml;
...
public final class FinalMobilenetFold1 {
  @NonNull
  private final Model model;

  private FinalMobilenetFold1(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "FinalMobilenetFold1.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static FinalMobilenetFold1 newInstance(@NonNull Context context) throws IOException {
    return new FinalMobilenetFold1(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static FinalMobilenetFold1 newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new FinalMobilenetFold1(context, options);
  }
