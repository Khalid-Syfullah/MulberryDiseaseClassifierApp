...
public class MulberryDiseaseClassifierActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MulberryDiseaseClassifierActivity.super.onBackPressed();
            }
        });
...
//            MappedByteBuffer tfliteModel = fileChannel.map(FileChannel.MapMode.READ_ONLY, startoffset, declaredLength);
            ...
            MappedByteBuffer tfliteModel = FileUtil.loadMappedFile(MulberryDiseaseClassifierActivity.this,"FinalMobilenetFold1.tflite");
            Interpreter tflite = new Interpreter(tfliteModel, tfliteOptions);

            // Loads labels out from the label file.
            labels = FileUtil.loadLabels(MulberryDiseaseClassifierActivity.this,"labels.txt");
            ...
            for(int i=0;i<10;i++){
                ...
                Log.d(TAG, "After Normalization: (Float Array) "+inputTensorImage.getTensorBuffer().getFloatArray()[i]);
...
//
            ...
            Log.d(TAG, "Input Image Shape: "+ inputImageShape[0] +  " "+inputImageShape[1] +  " "+ inputImageShape[2] + " " + inputImageShape[3]);
            ...
            Log.d(TAG, "Output Image Shape: "+ probabilityImageShape[0] +  " "+ probabilityImageShape[1]);
